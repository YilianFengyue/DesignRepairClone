                ...
                <div className="flex h-32">
                  ...
                  <div className="flex-1 p-4 flex flex-col justify-between">
                    ...
                    <div className="flex justify-between items-end">
                      ...
                      <button 
                        className="w-[48px] h-[48px] rounded-[12px] flex items-center justify-center bg-[#6750A4] hover:bg-[#7C3AED] active:bg-[#5A4A8A] transition-colors shadow-md text-white"
