...
function MoreIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="none"><circle cx="12" cy="12" r="2.5"/><circle cx="12" cy="5" r="2.5"/><circle cx="12" cy="19" r="2.5"/></svg>
  )
}
    ...
    <div className="min-h-screen bg-gray-50 p-6 font-sans">
      ...
      <header className="bg-white shadow-md flex items-center justify-between px-6 py-4 mb-8 rounded-lg">
        <div className="flex items-center gap-4">
          <button className="text-gray-700 hover:bg-gray-100 p-2 rounded-full transition-colors" aria-label="Open menu" title="Open menu">
            <MenuIcon />
          </button>
          <h1 className="text-2xl font-bold text-gray-900">Task Manager</h1>
        </div>
        <div className="flex gap-2">
          <button className="bg-blue-600 text-white text-sm px-6 py-3 rounded-full hover:bg-blue-700 transition-colors shadow-md font-medium" aria-label="Open profile">Profile</button>
        </div>
      </header>
      ...
      <main className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
          <div className="flex justify-between items-start gap-4">
            ...
            <button className="text-gray-700 hover:bg-gray-100 p-2 rounded-full transition-colors flex-shrink-0" aria-label="More options" title="More options">
              <MoreIcon />
            </button>
          </div>
        ...
        <div className="bg-white rounded-xl overflow-hidden shadow-sm">
          ...
          <div className="px-6 py-4 border-b border-gray-200 flex items-center gap-4 min-h-[56px]">
            ...
            <span className="text-gray-900 text-base font-medium">Medium Priority</span>
          </div>
      ...
      {/* FAB - Fixed */}
      <button className="fixed bottom-8 right-8 w-14 h-14 bg-blue-600 text-white flex items-center justify-center rounded-full shadow-lg hover:bg-blue-700 hover:shadow-xl transition-all" aria-label="Add new task" title="Add new task">
        <PlusIcon />
      </button>
    </div>
  );
